...
sealed class BotNavItem(var title: Int, var icon: Int, var route: String) {
    ...
    object ListBarangSewaScreen :
        BotNavItem(R.string.barang_sewa, R.drawable.trekking, ConstVariable.BARANG_SEWA_ROUTE)

    object PembayaranScreen : BotNavItem(
        R.string.pembayaran, R.drawable.buy,
        ConstVariable.PEMBAYARAN_ROUTE
    )

    object RiwayatPemesananScreen :
        BotNavItem(R.string.riwayat, R.drawable.note, ConstVariable.RIWAYAT_PEMESANAN_ROUTE)
}
